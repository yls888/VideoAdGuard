...
4. 广告内容必须与置顶评论或附加信息中的商品链接标题相对应，但由于字幕可能会识别错误，你需要对比置顶评论中的部分产品关键字，是否存在与我提供的字幕内容谐音相关的词，用来辅助判断。如“咸鱼”和“闲鱼”，“转”和“赚”等等。
5. 一段广告的检测需要完整：包含商品介绍前的转折性引入，介绍商品的特点、优势、适用场景、价格、购买渠道等信息，以及商品介绍后的引导购买部分
6. 如果检测内容中含有转转、闲鱼等APP的推广，则更倾向于认定为广告。
...
2. 纯粹的产品介绍、评测、对比，如果没有明确的购买引导，不认定为广告
3. 如果置顶评论中没有商品链接，则更倾向于认定为无广告
4. 广告内容必须与置顶评论或附加信息中的链接标题相对应，但由于字幕可能会识别错误，你需要对比置顶评论中的部分产品关键字，是否存在与我提供的字幕内容谐音相关的词，用来辅助判断。如“咸鱼”和“闲鱼”，“转”和“赚”等等
5. 一段广告的检测需要完整：包含商品介绍前的转折性引入，介绍商品的特点、优势、适用场景、价格、购买渠道等信息，以及商品介绍后的引导购买部分
6. 重点关注预提取的商品名称，仅在字幕中寻找与这些商品相关的广告内容
7. 如果检测内容中含有转转、闲鱼等APP的推广，则更倾向于认定为广告
